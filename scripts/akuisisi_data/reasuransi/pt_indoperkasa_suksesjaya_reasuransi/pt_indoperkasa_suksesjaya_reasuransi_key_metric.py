...
def main():
    parser = argparse.ArgumentParser(description="Extract Indoperkasa metrics from TXT file")
    ...
    company_dir = period_dir / "reasuransi" / "pt_indoperkasa_suksesjaya_reasuransi"
    INPUT_TXT = company_dir / f"pt_indoperkasa_suksesjaya_reasuransi_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_indoperkasa_suksesjaya_reasuransi_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company = "PT Indoperkasa Suksesjaya Reasuransi"
    jenis = "Reasuransi"

    aset_2026, aset_prev = extract_two_numbers(text, "35 Jumlah Aset (22 + 34)")
