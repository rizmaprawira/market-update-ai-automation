...
def main():
    parser = argparse.ArgumentParser(description="Extract Tugu Reasuransi metrics from TXT file")
    ...
    company_dir = period_dir / "reasuransi" / "pt_tugu_reasuransi_indonesia"
    INPUT_TXT = company_dir / f"pt_tugu_reasuransi_indonesia_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_tugu_reasuransi_indonesia_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company = "PT Tugu Reasuransi Indonesia"
    jenis = "Reasuransi"

    aset_2026, aset_prev = extract_two_numbers(text, "35 Jumlah Aset (21 + 34)")
    ekuitas_2026, ekuitas_prev = extract_two_numbers(text, "20 Jumlah Ekuitas (16 + 19)")
    ...
    laba_komp_2026, laba_komp_2025 = extract_two_numbers(text, "26 TOTAL LABA KOMPREHENSIF")
