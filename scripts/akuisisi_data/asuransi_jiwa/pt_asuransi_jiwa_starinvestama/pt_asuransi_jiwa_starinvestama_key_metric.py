...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_asuransi_jiwa_starinvestama"
    INPUT_TXT = company_dir / f"pt_asuransi_jiwa_starinvestama_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_jiwa_starinvestama_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Asuransi Jiwa Starinvestama", "Asuransi Jiwa"
