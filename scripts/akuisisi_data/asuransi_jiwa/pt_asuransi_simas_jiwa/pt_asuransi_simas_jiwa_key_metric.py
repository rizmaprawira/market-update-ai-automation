...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_asuransi_simas_jiwa"
    INPUT_TXT = company_dir / f"pt_asuransi_simas_jiwa_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_simas_jiwa_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Asuransi Simas Jiwa", "Asuransi Jiwa"
