...
LOGGER = logging.getLogger("download_pt_asuransi_simas_jiwa")
SOURCE_URL = "https://about.simasjiwa.co.id/kinerja"
COMPANY_ID = "pt_asuransi_simas_jiwa"
COMPANY_NAME = "PT Asuransi Simas Jiwa"
