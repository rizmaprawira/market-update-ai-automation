...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_china_life_insurance_indonesia"
    INPUT_TXT = company_dir / f"pt_china_life_insurance_indonesia_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_china_life_insurance_indonesia_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT China Life Insurance Indonesia", "Asuransi Jiwa"
