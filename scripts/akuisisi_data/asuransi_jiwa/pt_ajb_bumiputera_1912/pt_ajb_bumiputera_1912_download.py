...
LOGGER = logging.getLogger("download_pt_ajb_bumiputera_1912")
SOURCE_URL = "https://www.bumiputera.com/listdocument/document/our_company/financial_report/0/15/0/1"
COMPANY_ID = "pt_ajb_bumiputera_1912"
COMPANY_NAME = "AJB Bumiputera 1912"
...
def main():
    ...
    if output_pdf.exists() and not args.force:
        ...
        write_manifest(output_dir, [{
            ...
            "source_page_url": SOURCE_URL, "discovered_page_url": discovered_url,
            "pdf_url": selected_candidate.url, "target_year": args.year, "target_month": args.month,
            "output_path": str(output_pdf), "status": "skipped_existing", "reason": "file already exists",
            "timestamp": current_timestamp()
        }])
        return 0
