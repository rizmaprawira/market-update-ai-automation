...
def main():
    parser = argparse.ArgumentParser(description="Extract AJB Bumiputera 1912 metrics from TXT file")
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_ajb_bumiputera_1912"
    INPUT_TXT = company_dir / f"pt_ajb_bumiputera_1912_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_ajb_bumiputera_1912_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company = "PT AJB Bumiputera 1912"
    jenis = "Asuransi Jiwa"
