...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_indolife_pensiontama"
    INPUT_TXT = company_dir / f"pt_indolife_pensiontama_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_indolife_pensiontama_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Indolife Pensiontama", "Asuransi Jiwa"
