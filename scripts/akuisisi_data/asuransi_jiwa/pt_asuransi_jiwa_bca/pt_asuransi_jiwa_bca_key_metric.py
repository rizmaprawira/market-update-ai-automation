...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_asuransi_jiwa_bca"
    INPUT_TXT = company_dir / f"pt_asuransi_jiwa_bca_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_jiwa_bca_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Asuransi Jiwa BCA", "Asuransi Jiwa"
    ...
    jml_beban_asuransi_curr, jml_beban_asuransi_prev = extract_two_numbers(text, "Jumlah beban Asuransi|Jumlah Beban Asuransi")
