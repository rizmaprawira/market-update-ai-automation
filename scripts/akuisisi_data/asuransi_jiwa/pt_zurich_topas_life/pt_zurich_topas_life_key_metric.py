...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_zurich_topas_life"
    INPUT_TXT = company_dir / f"pt_zurich_topas_life_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_zurich_topas_life_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Zurich Topas Life", "Asuransi Jiwa"
