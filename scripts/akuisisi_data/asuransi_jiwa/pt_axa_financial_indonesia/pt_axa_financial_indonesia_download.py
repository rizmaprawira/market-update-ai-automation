...
LOGGER = logging.getLogger("download_pt_axa_financial_indonesia")
SOURCE_URL = "https://www.axa.co.id/laporan-tahunan-afi"
COMPANY_ID = "pt_axa_financial_indonesia"
COMPANY_NAME = "PT AXA Financial Indonesia"
