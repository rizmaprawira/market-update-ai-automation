...
LOGGER = logging.getLogger("download_pt_asuransi_jiwa_nasional")
SOURCE_URL = "https://www.nasionallife.co.id/Financial_Reports.html"
COMPANY_ID = "pt_asuransi_jiwa_nasional"
COMPANY_NAME = "PT Asuransi Jiwa Nasional"
