...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_asuransi_jiwa_mandiri_inhealth_indonesia"
    INPUT_TXT = company_dir / f"pt_asuransi_jiwa_mandiri_inhealth_indonesia_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_jiwa_mandiri_inhealth_indonesia_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Asuransi Jiwa Mandiri Inhealth Indonesia", "Asuransi Jiwa"
