...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_prudential_life_assurance"
    INPUT_TXT = company_dir / f"pt_prudential_life_assurance_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_prudential_life_assurance_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Prudential Life Assurance", "Asuransi Jiwa"
