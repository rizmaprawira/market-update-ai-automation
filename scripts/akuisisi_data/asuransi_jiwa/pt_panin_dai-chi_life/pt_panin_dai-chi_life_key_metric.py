...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_panin_dai-chi_life"
    INPUT_TXT = company_dir / f"pt_panin_dai-chi_life_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_panin_dai-chi_life_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Panin Dai-chi Life", "Asuransi Jiwa"
