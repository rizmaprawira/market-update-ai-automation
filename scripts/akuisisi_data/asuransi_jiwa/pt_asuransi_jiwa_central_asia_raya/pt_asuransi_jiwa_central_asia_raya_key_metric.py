...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_asuransi_jiwa_central_asia_raya"
    INPUT_TXT = company_dir / f"pt_asuransi_jiwa_central_asia_raya_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_jiwa_central_asia_raya_key_metric_{args.yyyy}_{args.mm:02d}.csv"
