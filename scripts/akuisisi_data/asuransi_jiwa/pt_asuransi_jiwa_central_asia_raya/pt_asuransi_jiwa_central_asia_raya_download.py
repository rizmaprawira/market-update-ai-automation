...
LOGGER = logging.getLogger("download_pt_asuransi_jiwa_central_asia_raya")
SOURCE_URL = "https://www.car.co.id/tentang-kami/informasi-umum/laporan-keuangan/"
COMPANY_ID = "pt_asuransi_jiwa_central_asia_raya"
COMPANY_NAME = "PT Asuransi Jiwa Central Asia Raya"
