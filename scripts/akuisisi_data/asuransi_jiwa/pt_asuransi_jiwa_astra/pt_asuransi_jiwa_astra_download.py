...
LOGGER = logging.getLogger("download_pt_asuransi_jiwa_astra")
SOURCE_URL = "https://www.astralife.co.id/laporan-keuangan/"
COMPANY_ID = "pt_asuransi_jiwa_astra"
COMPANY_NAME = "PT Asuransi Jiwa Astra"
