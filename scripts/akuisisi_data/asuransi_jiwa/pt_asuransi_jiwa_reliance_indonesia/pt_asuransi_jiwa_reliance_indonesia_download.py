...
LOGGER = logging.getLogger("download_pt_asuransi_jiwa_reliance_indonesia")
SOURCE_URL = "https://reliance-life.co.id/keuangan"
COMPANY_ID = "pt_asuransi_jiwa_reliance_indonesia"
