...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_asuransi_jiwa_sealnsure"
    INPUT_TXT = company_dir / f"pt_asuransi_jiwa_sealnsure_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_jiwa_sealnsure_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Asuransi Jiwa Sealnsure", "Asuransi Jiwa"
