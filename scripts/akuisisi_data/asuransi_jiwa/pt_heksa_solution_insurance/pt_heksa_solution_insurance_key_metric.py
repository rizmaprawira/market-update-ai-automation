...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_heksa_solution_insurance"
    INPUT_TXT = company_dir / f"pt_heksa_solution_insurance_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_heksa_solution_insurance_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Heksa Solution Insurance", "Asuransi Jiwa"
