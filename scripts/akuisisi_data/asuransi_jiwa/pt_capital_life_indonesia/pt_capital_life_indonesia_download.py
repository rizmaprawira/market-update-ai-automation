...
LOGGER = logging.getLogger("download_pt_capital_life_indonesia")
SOURCE_URL = "https://www.capitallife.co.id/laporan"
COMPANY_ID = "pt_capital_life_indonesia"
COMPANY_NAME = "PT Capital Life Indonesia"
