...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_axa_mandiri_financial_services"
    INPUT_TXT = company_dir / f"pt_axa_mandiri_financial_services_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_axa_mandiri_financial_services_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Axa Mandiri Financial Services", "Asuransi Jiwa"
