"""Download financial reports for PT Hanwha Life Insurance Indonesia."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_pt_hanwha_life_insurance_indonesia")
SOURCE_URL = "https://www.hanwhalife.co.id/laporan-keuangan/"
COMPANY_ID = "pt_hanwha_life_insurance_indonesia"
COMPANY_NAME = "PT Hanwha Life Insurance Indonesia"
    ...
    try:
        ...
        try:
            with sync_playwright() as p:
                ...
                response = page.goto(selected_candidate.url, timeout=args.timeout * 1000, wait_until="commit")
