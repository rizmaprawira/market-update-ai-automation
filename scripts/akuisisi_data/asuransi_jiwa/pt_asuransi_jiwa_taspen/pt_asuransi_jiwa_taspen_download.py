...
LOGGER = logging.getLogger("download_pt_asuransi_jiwa_taspen")
SOURCE_URL = "https://www.taspenlife.com/about?tab=laporan"
COMPANY_ID = "pt_asuransi_jiwa_taspen"
COMPANY_NAME = "PT Asuransi Jiwa Taspen"
