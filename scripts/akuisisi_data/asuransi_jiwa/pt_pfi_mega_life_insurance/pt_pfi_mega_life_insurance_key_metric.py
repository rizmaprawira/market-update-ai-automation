...
def main():
    parser = argparse.ArgumentParser(description="Extract PFI Mega Life metrics from TXT file")
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_pfi_mega_life_insurance"
    INPUT_TXT = company_dir / f"pt_pfi_mega_life_insurance_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_pfi_mega_life_insurance_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    aset_curr, aset_prev = extract_two_numbers(text, "Jumlah Aset (24 + 37)")
