...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_lippo_life_assurance"
    INPUT_TXT = company_dir / f"pt_lippo_life_assurance_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_lippo_life_assurance_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Lippo Life Assurance", "Asuransi Jiwa"
