...
LOGGER = logging.getLogger("download_pt_asuransi_jiwa_teguh_pelita_pelindung")
SOURCE_URL = "https://equiralife.co.id/id/report/financial"
COMPANY_ID = "pt_asuransi_jiwa_teguh_pelita_pelindung"
COMPANY_NAME = "PT Asuransi Jiwa Teguh Pelita Pelindung"
