...
LOGGER = logging.getLogger("download_pt_asuransi_jiwa_sequis_life")
SOURCE_URL = "https://www.sequis.co.id/id/tentang-sequis/life/laporan-perusahaan"
COMPANY_ID = "pt_asuransi_jiwa_sequis_life"
