...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_asuransi_jiwa_sequis_life"
    INPUT_TXT = company_dir / f"pt_asuransi_jiwa_sequis_life_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_jiwa_sequis_life_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Asuransi Jiwa Sequis Life", "Asuransi Jiwa"
