...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_sun_life_financial_indonesia"
    INPUT_TXT = company_dir / f"pt_sun_life_financial_indonesia_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_sun_life_financial_indonesia_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Sun Life Financial Indonesia", "Asuransi Jiwa"
