...
def main():
    ...
    company_dir = period_dir / "asuransi_jiwa" / "pt_msig_life_insurance_indonesia_tbk"
    INPUT_TXT = company_dir / f"pt_msig_life_insurance_indonesia_tbk_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_msig_life_insurance_indonesia_tbk_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company, jenis = "PT Msig Life Insurance Indonesia Tbk", "Asuransi Jiwa"
