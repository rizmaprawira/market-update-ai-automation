...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_tugu_pratama_indonesia_tbk"
    INPUT_TXT = company_dir / f"pt_asuransi_tugu_pratama_indonesia_tbk_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_tugu_pratama_indonesia_tbk_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    aset_2026, aset_prev = extract_two_numbers(text, "10 Jumlah Aset")
    ekuitas_2026, ekuitas_prev = extract_two_numbers(text, "22 Jumlah Ekuitas")
    ...
    rows = [{
        "periode": current_period, "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Tugu Pratama Indonesia Tbk",
        ...
        "periode": f"{args.yyyy-1}-{args.mm:02d}", "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Tugu Pratama Indonesia Tbk",
