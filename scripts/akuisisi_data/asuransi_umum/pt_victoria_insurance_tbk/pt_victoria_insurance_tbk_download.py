"""Download financial reports for PT Victoria Insurance Tbk.."""
import argparse
import logging
import sys
import time
...
LOGGER = logging.getLogger("download_pt_victoria_insurance_tbk")
SOURCE_URL = "https://victoriainsurance.co.id/laporan-bulanan/"
COMPANY_ID = "pt_victoria_insurance_tbk"
COMPANY_NAME = "PT Victoria Insurance Tbk."
...
def main():
    ...
    try:
        LOGGER.info("Using browser with domcontentloaded (PDF links are JS-rendered)")
        html, discovered_url = fetch_html_browser_domready(SOURCE_URL, args.timeout, extra_wait_ms=2000)
