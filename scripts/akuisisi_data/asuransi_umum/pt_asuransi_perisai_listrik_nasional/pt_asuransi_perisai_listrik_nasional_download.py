"""Download financial reports for PT Asuransi Perisai Listrik Nasional."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_pt_asuransi_perisai_listrik_nasional")
SOURCE_URL = "https://plninsurance.co.id/laporanbulanan/"
COMPANY_ID = "pt_asuransi_perisai_listrik_nasional"
COMPANY_NAME = "PT Asuransi Perisai Listrik Nasional"
CATEGORY = "asuransi_umum"

def extract_perisai_pdfs(html, base_url, year, month):
...
def main():
    ...
    candidates = extract_perisai_pdfs(html, discovered_url, args.year, args.month)
