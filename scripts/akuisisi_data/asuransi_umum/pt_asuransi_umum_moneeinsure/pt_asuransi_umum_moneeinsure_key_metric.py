...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_umum_moneeinsure"
    INPUT_TXT = company_dir / f"pt_asuransi_umum_moneeinsure_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_umum_moneeinsure_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    rows = [{
        "periode": current_period, "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Umum Moneeinsure",
        ...
        "periode": f"{args.yyyy-1}-{args.mm:02d}", "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Umum Moneeinsure",
