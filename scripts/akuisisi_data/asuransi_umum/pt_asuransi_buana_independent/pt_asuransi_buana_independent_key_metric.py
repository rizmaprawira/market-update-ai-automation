...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_buana_independent"
    INPUT_TXT = company_dir / f"pt_asuransi_buana_independent_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_buana_independent_key_metric_{args.yyyy}_{args.mm:02d}.csv"
