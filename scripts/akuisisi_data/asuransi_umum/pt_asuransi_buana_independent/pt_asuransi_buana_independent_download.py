"""Download financial reports for PT Asuransi Buana Independent."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_pt_asuransi_buana_independent")
SOURCE_URL = "https://abi.id/tentang-kami/"
COMPANY_ID = "pt_asuransi_buana_independent"
COMPANY_NAME = "PT Asuransi Buana Independent"
CATEGORY = "asuransi_umum"

def extract_abi_pdfs(html, base_url, year, month):
...
def main():
    ...
    candidates = extract_abi_pdfs(html, discovered_url, args.year, args.month)
