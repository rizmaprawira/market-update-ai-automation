"""Download financial reports for PT Asuransi Candi Utama."""
import argparse
import logging
import sys
import time
...
LOGGER = logging.getLogger("download_pt_asuransi_candi_utama")
SOURCE_URL = "https://candiutama.co.id/InvestorRelations"
COMPANY_ID = "pt_asuransi_candi_utama"
COMPANY_NAME = "PT Asuransi Candi Utama"
