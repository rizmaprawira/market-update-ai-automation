...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_reliance_indonesia"
    INPUT_TXT = company_dir / f"pt_asuransi_reliance_indonesia_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_reliance_indonesia_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    rows = [{
        "periode": current_period, "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Reliance Indonesia",
        ...
        "periode": f"{args.yyyy-1}-{args.mm:02d}", "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Reliance Indonesia",
