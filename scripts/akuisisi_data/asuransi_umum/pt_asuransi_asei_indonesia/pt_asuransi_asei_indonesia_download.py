"""Download financial reports for PT Asuransi Asei Indonesia."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_pt_asuransi_asei_indonesia")
SOURCE_URL = "https://www.asei.co.id/reports/laporan-bulanan/"
COMPANY_ID = "pt_asuransi_asei_indonesia"
COMPANY_NAME = "PT Asuransi Asei Indonesia"
...
def main():
    ...
    candidates = extract_asei_pdfs(html, discovered_url, args.year, args.month)
