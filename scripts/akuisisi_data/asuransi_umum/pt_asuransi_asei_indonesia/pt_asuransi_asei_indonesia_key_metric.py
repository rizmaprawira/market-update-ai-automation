...
def main():
    parser = argparse.ArgumentParser(description="Extract ASEI metrics from TXT file")
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_asei_indonesia"
    INPUT_TXT = company_dir / f"pt_asuransi_asei_indonesia_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_asei_indonesia_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company = "PT Asuransi Asei Indonesia"
    jenis = "Asuransi Umum"
    ...
    pend_premi_2026, pend_premi_prev = extract_two_numbers(text, "Jumlah Pendapatan Premi Netto")
    ...
    premi_neto_2026, premi_neto_prev = extract_two_numbers(text, "Jumlah Premi Netto")
