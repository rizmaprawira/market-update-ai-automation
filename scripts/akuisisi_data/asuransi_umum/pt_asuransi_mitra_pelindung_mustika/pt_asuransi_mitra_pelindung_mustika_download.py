"""Download financial reports for PT Asuransi Mitra Pelindung Mustika."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_pt_asuransi_mitra_pelindung_mustika")
SOURCE_URL = "https://www.mpm-insurance.com/tentang-kami/laporan-finansial/"
COMPANY_ID = "pt_asuransi_mitra_pelindung_mustika"
COMPANY_NAME = "PT Asuransi Mitra Pelindung Mustika"
CATEGORY = "asuransi_umum"

def extract_mpm_pdfs(html, base_url, year, month):
...
def main():
    ...
    candidates = extract_mpm_pdfs(html, discovered_url, args.year, args.month)
