...
def main():
    parser = argparse.ArgumentParser(description="Extract Astra Buana metrics from TXT file")
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_astra_buana"
    INPUT_TXT = company_dir / f"pt_asuransi_astra_buana_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_astra_buana_key_metric_{args.yyyy}_{args.mm:02d}.csv"
