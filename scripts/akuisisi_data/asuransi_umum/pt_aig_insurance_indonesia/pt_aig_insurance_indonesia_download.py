"""Download financial reports for PT AIG Insurance Indonesia."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_pt_aig_insurance_indonesia")
SOURCE_URL = "https://www.aig.co.id/beranda/tentang-kami/laporan-keuangan"
COMPANY_ID = "pt_aig_insurance_indonesia"
COMPANY_NAME = "PT AIG Insurance Indonesia"
CATEGORY = "asuransi_umum"

def extract_aig_pdfs(html, base_url, year, month):
...
def main():
    ...
    candidates = extract_aig_pdfs(html, discovered_url, args.year, args.month)
