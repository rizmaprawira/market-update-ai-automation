"""Download financial reports for PT Asuransi MSIG Indonesia."""
import argparse
import logging
import sys
import time
...
LOGGER = logging.getLogger("download_pt_asuransi_msig_indonesia")
SOURCE_URL = "https://www.msig.co.id/id/laporan-keuangan-laporan-tahunan-dan-laporan-keberlanjutan"
COMPANY_ID = "pt_asuransi_msig_indonesia"
COMPANY_NAME = "PT Asuransi MSIG Indonesia"
