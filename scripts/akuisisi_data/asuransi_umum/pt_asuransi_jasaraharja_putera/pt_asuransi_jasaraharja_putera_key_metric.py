...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_jasaraharja_putera"
    INPUT_TXT = company_dir / f"pt_asuransi_jasaraharja_putera_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_jasaraharja_putera_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    aset_2026, aset_prev = extract_two_numbers(text, "JUMLAH ASET (23 + 36)")
    ...
    rows = [{
        "periode": current_period, "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Jasaraharja Putera",
        ...
        "periode": f"{args.yyyy-1}-{args.mm:02d}", "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Jasaraharja Putera",
