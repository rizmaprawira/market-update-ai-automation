...
def main():
    parser = argparse.ArgumentParser(description="Extract Artarindo metrics from TXT file")
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_artarindo"
    INPUT_TXT = company_dir / f"pt_asuransi_artarindo_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_artarindo_key_metric_{args.yyyy}_{args.mm:02d}.csv"
