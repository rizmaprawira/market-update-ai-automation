...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_china_taiping_insurance_indonesia"
    INPUT_TXT = company_dir / f"pt_china_taiping_insurance_indonesia_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_china_taiping_insurance_indonesia_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    rows = [{
        "periode": current_period, "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT China Taiping Insurance Indonesia",
        ...
        "periode": f"{args.yyyy-1}-{args.mm:02d}", "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT China Taiping Insurance Indonesia",
