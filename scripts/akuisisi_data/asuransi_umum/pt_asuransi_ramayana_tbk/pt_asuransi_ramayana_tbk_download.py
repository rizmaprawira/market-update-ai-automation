"""Download financial reports for PT Asuransi Ramayana Tbk.."""
import argparse
import logging
import sys
import time
...
LOGGER = logging.getLogger("download_pt_asuransi_ramayana_tbk")
SOURCE_URL = "https://asuransiramayana.co.id/berita/info-investor/laporan-keuangan"
BASE_URL = "https://asuransiramayana.co.id"
COMPANY_ID = "pt_asuransi_ramayana_tbk"
COMPANY_NAME = "PT Asuransi Ramayana Tbk."
CATEGORY = "asuransi_umum"


def find_ramayana_pdf_url(year, month, session, timeout):
    """Try deterministic URL pattern for Ramayana PDFs."""
    month_name = MONTH_LABELS[month]

    # Pattern: /storage/app/media/laporan%20keuangan/Laporan%20Bulanan%20YYYY/MM%20MonthName.pdf
    pdf_url = f"{BASE_URL}/storage/app/media/laporan%20keuangan/Laporan%20Bulanan%20{year}/{month:02d}%20{month_name}.pdf"
    try:
...
def main():
    ...
    pdf_url = find_ramayana_pdf_url(args.year, args.month, session, args.timeout)
