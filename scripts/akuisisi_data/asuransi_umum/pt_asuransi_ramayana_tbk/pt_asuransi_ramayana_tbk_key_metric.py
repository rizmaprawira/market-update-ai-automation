...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_ramayana_tbk"
    INPUT_TXT = company_dir / f"pt_asuransi_ramayana_tbk_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_ramayana_tbk_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    aset_2026, aset_prev = extract_two_numbers(text, "36 Jumlah Aset")
    ...
    rows = [{
        "periode": current_period, "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Ramayana Tbk",
        ...
        "periode": f"{args.yyyy-1}-{args.mm:02d}", "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Asuransi Ramayana Tbk",
