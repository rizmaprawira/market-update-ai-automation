...
def main():
    parser = argparse.ArgumentParser(description="Extract Bhakti Bhayangkara metrics from TXT file")
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_asuransi_bhakti_bhayangkara"
    INPUT_TXT = company_dir / f"pt_asuransi_bhakti_bhayangkara_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_asuransi_bhakti_bhayangkara_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    company = "PT Asuransi Bhakti Bhayangkara"
    jenis = "Asuransi Umum"
    ...
    pend_premi_2026, pend_premi_prev = extract_two_numbers(text, "12 Jumlah Pendapatan Underwriting")
    ...
    laba_komp_2026, laba_komp_prev = extract_two_numbers(text, "27 Total Laba (Rugi) Komprehensif")
