"""Download financial reports for PT MNC Asuransi Indonesia."""
import argparse
import logging
import sys
import time
...
LOGGER = logging.getLogger("download_pt_mnc_asuransi_indonesia")
SOURCE_URL = "https://www.mnc-insurance.com/about/report"
COMPANY_ID = "pt_mnc_asuransi_indonesia"
COMPANY_NAME = "PT MNC Asuransi Indonesia"
...
def main():
    ...
    if http_status is not None:
        ...
        LOGGER.info(f"File already exists, skipping: {output_pdf}")
