...
def main():
    ...
    company_dir = period_dir / "asuransi_umum" / "pt_avrist_general_insurance"
    INPUT_TXT = company_dir / f"pt_avrist_general_insurance_{args.yyyy}_{args.mm:02d}.txt"
    COMPANY_CSV = company_dir / f"pt_avrist_general_insurance_key_metric_{args.yyyy}_{args.mm:02d}.csv"
    ...
    rows = [{
        "periode": current_period, "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Avrist General Insurance",
        ...
        "periode": f"{args.yyyy-1}-{args.mm:02d}", "jenis_asuransi": "Asuransi Umum", "nama_perusahaan": "PT Avrist General Insurance",
