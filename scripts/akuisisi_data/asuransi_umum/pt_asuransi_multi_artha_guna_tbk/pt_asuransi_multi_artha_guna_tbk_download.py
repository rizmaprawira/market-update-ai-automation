"""Download financial reports for PT Asuransi Multi Artha Guna Tbk.."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_pt_asuransi_multi_artha_guna_tbk")
SOURCE_URL = "https://www.mag.co.id/financial-report/"
COMPANY_ID = "pt_asuransi_multi_artha_guna_tbk"
COMPANY_NAME = "PT Asuransi Multi Artha Guna Tbk."
CATEGORY = "asuransi_umum"

def extract_mag_pdfs(html, base_url, year, month):
...
def main():
    ...
    candidates = extract_mag_pdfs(html, discovered_url, args.year, args.month)
